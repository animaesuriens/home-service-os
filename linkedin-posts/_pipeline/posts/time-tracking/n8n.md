...
Here's how n8n handles this sync:
...
n8n pulls fresh job codes and project data. New sites and departments become available for assignment immediately.
...
System checks if this is a correction, deletion, or brand new entry. n8n's node-based workflow makes this branching logic transparent.
