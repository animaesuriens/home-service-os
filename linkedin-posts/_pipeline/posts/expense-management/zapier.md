...
When a new bill hits your accounting software, Zapier pulls the expense data and starts hunting for connections. It searches your Airtable job records for matching customer references, linking that vendor bill to the right client account.
...
The system then checks whether this expense belongs to a main job or a specific project phase within that job. Zapier's step-by-step Zap structure keeps this logic clean and reliable.
...
Finally, Zapier saves everything to Airtable — expense data, attachment links, customer connections, job relationships. All locked in automatically.
